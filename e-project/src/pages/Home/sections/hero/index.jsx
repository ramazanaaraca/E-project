...
function Hero() {
    return(
        <>
            ...
            classcon='h-full'
            >
                <div className="flex lg:items-center max-lg:pt-[100px] item-start  lg:justify-end justify-center lg:text-start text-center  h-full">
                    <div className="xl:w-[620px] lg:w-[500px] w-full flex lg:items-start items-center flex-col">
                        <h1 className="lg:text-5xl text-4xl xl:text-7xl font-medium lg:max-w-full w-ful max-w-[300px] ">Listen to 
